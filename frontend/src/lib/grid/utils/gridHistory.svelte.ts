...
// use the history stack). It does NOT need to be in gridContext — local $state is sufficient.
...
export function createHistoryController() {
  // Stacks hold ARRAYS of actions (batches) for multi-cell undo/redo support
