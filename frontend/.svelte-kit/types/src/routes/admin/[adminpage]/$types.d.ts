...
type RouteParams = { adminpage: string };
type RouteId = '/admin/[adminpage]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/admin/[adminpage]/+page.server.js').load>>>>>>;
